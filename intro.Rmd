...
Here is an example by using borders_inc_age dataset (download  [here](https://github.com/Public-Health-Scotland/rmarkdown-training-online/raw/master/data/borders_inc_age.csv)) to calculate number of records according to gender:

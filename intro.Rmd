...
Now let's apply our knowledge and do some exercises! We are going to create a data report using borders_inc_age. 

**Exercise 1:**

Set a parameter for HBRes with selections Ayrshire & Arran, Borders and Fife. Calculate number of records and average length of stay – split them into 2 bullet points. Make number of records as bold and length of stay as italic.

**Exercise 2:**

Create a table for the number of records split by ManagementofPatient using kable. Also format the table using flextable with the following features:
...
You can download the R Markdown exercise files [here](https://github.com/Public-Health-Scotland/rmarkdown-training-online/tree/master/exercise). Please fill your code into the places with capital words. You can see the answers in "exercise-answer.Rmd".

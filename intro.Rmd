...
You can download the R Markdown exercise files [here](https://github.com/Public-Health-Scotland/rmarkdown-training-online/tree/master/data). Please fill your code into the places with capital words. You can see the answers in "exercise-answer.Rmd".
